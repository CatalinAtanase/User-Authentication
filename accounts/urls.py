...
urlpatterns = [
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(subject_template_name='accounts/password_reset_subject.txt', email_template_name='accounts/password_reset_email.html', template_name='accounts/password_reset.html'), name='password_reset'),
